...
interface FlickerApi {
    ...
    @GET("/services/rest/?method=flickr.photos.search&api_key=f1c0ab5110600a9f1116e57088c308d1&format=json&nojsoncallback=1&extras=url_m,owner_name,views") // we always want page0 so we wrote in link
